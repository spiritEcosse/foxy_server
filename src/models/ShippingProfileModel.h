...
public:
    ...
    struct Field: public BaseModel::Field
    {
        ...
        static inline BaseField processingTime =
            BaseField("processing_time", tableName);
        ...
        static inline BaseField shippingUpgradeCost =
            BaseField("shipping_upgrade_cost", tableName);

        Field()
            : BaseModel<ShippingProfileModel>::Field()
        {
    ...
    explicit ShippingProfileModel(const Json::Value &json)
        : BaseModel(json)
    {
