...
api::v1::BaseCRUD<T, R>::convertSafeStringMapToStdMap(const drogon::SafeStringMap<std::string> &safeMap) const {
...
template<class T, class R>
void api::v1::BaseCRUD<T, R>::deleteItem(const drogon::HttpRequestPtr &req,
                                         std::function<void(const drogon::HttpResponsePtr &)> &&callback,
...
template<class T, class R>
void api::v1::BaseCRUD<T, R>::deleteItems(const drogon::HttpRequestPtr &req,
                                          std::function<void(const drogon::HttpResponsePtr &)> &&callback) const {
    auto callbackPtr = std::make_shared<std::function<void(const drogon::HttpResponsePtr &)>>(std::move(callback));
...
template<class T, class R>
void api::v1::BaseCRUD<T, R>::getItems(
    const drogon::HttpRequestPtr &req,
    std::shared_ptr<std::function<void(const drogon::HttpResponsePtr &)>> callbackPtr,
    std::function<void(std::vector<T>)> successCallback) const {
...
template<class T, class R>
void api::v1::BaseCRUD<T, R>::createItem(const drogon::HttpRequestPtr &req,
                                         std::function<void(const drogon::HttpResponsePtr &)> &&callback) const {
    auto callbackPtr = std::make_shared<std::function<void(const drogon::HttpResponsePtr &)>>(std::move(callback));
...
template<class T, class R>
void api::v1::BaseCRUD<T, R>::createItems(const drogon::HttpRequestPtr &req,
                                          std::function<void(const drogon::HttpResponsePtr &)> &&callback) const {
    auto callbackPtr = std::make_shared<std::function<void(const drogon::HttpResponsePtr &)>>(std::move(callback));
...
template<class T, class R>
void api::v1::BaseCRUD<T, R>::updateItems(const drogon::HttpRequestPtr &req,
                                          std::function<void(const drogon::HttpResponsePtr &)> &&callback) const {
    auto callbackPtr = std::make_shared<std::function<void(const drogon::HttpResponsePtr &)>>(std::move(callback));
...
template<class T, class R>
void api::v1::BaseCRUD<T, R>::getList(const drogon::HttpRequestPtr &req,
                                      std::function<void(const drogon::HttpResponsePtr &)> &&callback) const {
...
template<class T, class R>
void api::v1::BaseCRUD<T, R>::getOne([[maybe_unused]] const drogon::HttpRequestPtr &req,
                                     std::function<void(const drogon::HttpResponsePtr &)> &&callback,
                                     std::string &&stringId) const {
    auto callbackPtr = std::make_shared<std::function<void(const drogon::HttpResponsePtr &)>>(std::move(callback));
...
template<class T, class R>
void api::v1::BaseCRUD<T, R>::updateItem(const drogon::HttpRequestPtr &req,
                                         std::function<void(const drogon::HttpResponsePtr &)> &&callback,
                                         const std::string &stringId) const {
    auto callbackPtr = std::make_shared<std::function<void(const drogon::HttpResponsePtr &)>>(std::move(callback));
...
template<class T, class R>
void api::v1::BaseCRUD<T, R>::executeSqlQuery(
    std::shared_ptr<std::function<void(const drogon::HttpResponsePtr &)>> callbackPtr,
    const std::string &query,
    std::function<void(const drogon::orm::Result &,
    ...
    *dbClient << query >> [callbackPtr, handler](const drogon::orm::Result &r) {
        if(r.affectedRows() == 0) {
    ...
    } >> [this, callbackPtr](const drogon::orm::DrogonDbException &e) {
        this->handleSqlError(e, callbackPtr);
    };
}

template<class T, class R>
void api::v1::BaseCRUD<T, R>::handleSqlResult(
    const drogon::orm::Result &r,
    std::shared_ptr<std::function<void(const drogon::HttpResponsePtr &)>> callbackPtr) const {
...
template<class T, class R>
void api::v1::BaseCRUD<T, R>::handleSqlResultCreating(
    const drogon::orm::Result &r,
    std::shared_ptr<std::function<void(const drogon::HttpResponsePtr &)>> callbackPtr) const {
    auto resp = drogon::HttpResponse::newHttpJsonResponse(std::move(R::getJsonResponse(r)));
...
template<class T, class R>
void api::v1::BaseCRUD<T, R>::handleSqlResultItems(
    const drogon::orm::Result &r,
    std::shared_ptr<std::function<void(const drogon::HttpResponsePtr &)>> callbackPtr,
    drogon::HttpStatusCode statusCode) const {
    Json::Value jsonResponse;
...
template<class T, class R>
void api::v1::BaseCRUD<T, R>::handleSqlResultDeleting(
    const drogon::orm::Result &r,
    std::shared_ptr<std::function<void(const drogon::HttpResponsePtr &)>> callbackPtr) const {
    auto resp = drogon::HttpResponse::newHttpResponse();
...
template<class T, class R>
void api::v1::BaseCRUD<T, R>::handleSqlError(
...
template<class T, class R>
Json::Value api::v1::BaseCRUD<T, R>::getJsonResponse(const drogon::orm::Result &r) {
    return r[0][0].as<Json::Value>();
}

template<class T, class R>
bool api::v1::BaseCRUD<T, R>::checkItemsEmpty(
    const drogon::HttpRequestPtr &req,
    std::shared_ptr<std::function<void(const drogon::HttpResponsePtr &)>> callbackPtr) const {
...
template<class T, class R>
drogon::HttpResponsePtr api::v1::BaseCRUD<T, R>::checkBody(const drogon::HttpRequestPtr &req) const {
    if(!req->bodyLength()) {
        Json::Value jsonResponse;
...
template<class T, class R>
drogon::HttpResponsePtr api::v1::BaseCRUD<T, R>::check404(const drogon::HttpRequestPtr &req, bool raise404) const {
    if(raise404) {
        auto resp = drogon::HttpResponse::newHttpResponse();
        resp->setStatusCode(drogon::HttpStatusCode::k404NotFound);
        return resp;
