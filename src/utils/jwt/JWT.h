...
namespace api::utils::jwt {
    ...
    public:
        ...
        static JWT generateToken(const std::map<std::string, ::jwt::traits::kazuho_picojson::value_type>& claims = {},
    ...
    private:
        ...
        static void
        addClaimToAttributes(std::map<std::string, std::any>& attributes,
