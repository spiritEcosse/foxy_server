...
template
class api::v1::BaseCRUD<ItemModel, Item>;
template
class api::v1::BaseCRUD<PageModel, Page>;
template
class api::v1::BaseCRUD<UserModel, User>;
template
class api::v1::BaseCRUD<MediaModel, Media>;
template
class api::v1::BaseCRUD<UserModel, Auth>;
template
class api::v1::BaseCRUD<ShippingProfileModel, ShippingProfile>;
template
class api::v1::BaseCRUD<CountryModel, Country>;
template
class api::v1::BaseCRUD<ShippingRateModel, ShippingRate>;
template
class api::v1::BaseCRUD<OrderModel, Order>;
template
class api::v1::BaseCRUD<BasketItemModel, BasketItem>;
template
class api::v1::BaseCRUD<AddressModel, Address>;
