...
# Usage:
#   ./scripts/sonarcloud-check.sh              # Auto-detect: branch mode on dev/main, PR mode otherwise
#   ./scripts/sonarcloud-check.sh 48           # Force PR mode for PR #48
#   ./scripts/sonarcloud-check.sh --pr 48      # Force PR mode for PR #48 (explicit)
#   ./scripts/sonarcloud-check.sh --branch dev  # Force branch mode for dev
#
# Modes:
#   Branch mode (dev/main):          Full project health — ALL existing issues on the branch
...
# Configuration
PROJECT_KEY="spiritEcosse_foxy_server"
...
# ============================================================
# BRANCH MODE — Full project health (dev/main)
# ============================================================
if [[ "$MODE" == "branch" ]]; then
