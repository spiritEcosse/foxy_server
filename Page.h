...
class Page
{
  public:
    struct Cols
    {
        ...
        static const std::string _meta_description;
        static const std::string _description;
        static const std::string _canonical_url;
    };
    ...
    /**  For column meta_description  */
    ///Get the value of the column meta_description, returns the default value if the column is null
    const std::string &getValueOfMetaDescription() const noexcept;
    ///Return a shared_ptr object pointing to the column const value, or an empty shared_ptr object if the column is null
    const std::shared_ptr<std::string> &getMetaDescription() const noexcept;
    ///Set the value of the column meta_description
    void setMetaDescription(const std::string &pMetaDescription) noexcept;
    void setMetaDescription(std::string &&pMetaDescription) noexcept;
    ...
    /**  For column canonical_url  */
    ///Get the value of the column canonical_url, returns the default value if the column is null
    const std::string &getValueOfCanonicalUrl() const noexcept;
    ///Return a shared_ptr object pointing to the column const value, or an empty shared_ptr object if the column is null
    const std::shared_ptr<std::string> &getCanonicalUrl() const noexcept;
    ///Set the value of the column canonical_url
    void setCanonicalUrl(const std::string &pCanonicalUrl) noexcept;
    void setCanonicalUrl(std::string &&pCanonicalUrl) noexcept;
  ...
  private:
    ...
    std::shared_ptr<std::string> metaDescription_;
    std::shared_ptr<std::string> description_;
    std::shared_ptr<std::string> canonicalUrl_;
    struct MetaData
    {
